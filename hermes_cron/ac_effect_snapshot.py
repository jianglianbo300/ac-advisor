...
import os, subprocess, subprocess, sys
REAL = r"D:\work\ac-advisor\ac_effect_snapshot.py"
os.chdir(os.path.dirname(REAL))
PY = r"D:\work\ac-advisor\.venv\Scripts\python.exe"
if not os.path.exists(PY): PY = sys.executable
subprocess.run([PY, REAL] + sys.argv[1:], check=True, creationflags=subprocess.CREATE_NO_WINDOW)
